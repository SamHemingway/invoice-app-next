export const ICONS = {
  ...
  plus: (
    ...
    >
      <path
        fill="currentColor"
        d="M 6.942 11.023 L 6.942 6.942 L 11.023 6.942 L 11.023 4.104 L 6.942 4.104 L 6.942 0.023 L 4.104 0.023 L 4.104 4.104 L 0.023 4.104 L 0.023 6.942 L 4.104 6.942 L 4.104 11.023 L 6.942 11.023 Z"
      />
    </svg>
  ),
  sun: (
